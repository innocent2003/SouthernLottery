...
public class XSMTAdapter extends RecyclerView.Adapter<XSMTAdapter.Holder>{
    List<PrizeRow> list;

    public XSMTAdapter(List<PrizeRow> list) {
        this.list = list;
    }

    @NonNull
    @Override
    public XSMTAdapter.Holder onCreateViewHolder(
        ...
        return new XSMTAdapter.Holder(view);
    }

    @Override
    public void onBindViewHolder(
            @NonNull XSMTAdapter.Holder holder,
            int position) {
