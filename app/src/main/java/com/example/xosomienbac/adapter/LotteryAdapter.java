...
//import com.example.xoso.model.LotteryResult;
...
public class LotteryAdapter extends RecyclerView.Adapter<LotteryAdapter.ViewHolder> {
    ...
    private List<com.example.xosomienbac.adapter.LotteryResult> list;

    public LotteryAdapter(Context context, List<com.example.xosomienbac.adapter.LotteryResult> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.example.xosomienbac.adapter.LotteryResult item = list.get(position);
